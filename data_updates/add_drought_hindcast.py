...
def add_drought_hindcast(country, year_start, year_end):
    ...
    load.download_ecmwf_hindcast(filepath+filename, country, year_start, year_end)
    ...
    for rp in RETURN_PERIODS:
        ...
        drought_hindcast_files[rp] = filepath
    ...
    for country_settings in settings.get_setting("countries"):
        ...
        for adm_level in country_settings["admin-levels"]:
            ...
            for rp, filename in flood_hindcast_files.items():
